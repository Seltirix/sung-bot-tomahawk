        ...
        if (!args[0]) {
            ...
            message.channel.send({
                embed: {
                    ...
                    timestamp: new Date(),
                    description: `Utiliser les filtres, ${client.config.discord.prefix}filtre (le filtre). Exemple : ${client.config.discord.prefix}filtre 8D.`,
                },
            });
        } else {
